  ...
  return (
    <>
        ...
        <div className="container">
          <div className="header-left">
            <a className="brand" href="/">
              <img className="brand-logo" src="/assets/company logos/polyscan.png" alt="PolyScan" />
            </a>
          </div>
        ...
        <section className="services" id="services">
          <article className="service container" data-animate>
            <div className="service-grid">
              <div className="service-text">
                ...
                <button className="btn btn-primary service-action" data-action="chatbot">
                  Commencer
                </button>
              </div>
              <div className="service-media" aria-hidden="true">
                <div className="media-frame">
                  <img src="/assets/placeholders/chatbot.jpg" alt="Écran du chatbot financier PolyScan" loading="lazy" />
                </div>
              </div>
            </div>
          </article>
          ...
          <article className="service container" data-animate>
            <div className="service-grid service-grid--reverse">
              ...
              <div className="service-media" aria-hidden="true">
                <div className="media-frame">
                  <img src="/assets/placeholders/law.jpg" alt="Interface du scanner de projet de loi" loading="lazy" />
                </div>
              </div>
            </div>
          </article>
          ...
          <article className="service container" data-animate>
            <div className="service-grid">
              <div className="service-text">
                ...
                <button className="btn btn-primary service-action" data-action="search">
                  Commencer
                </button>
              </div>
              <div className="service-media" aria-hidden="true">
                <div className="media-frame">
                  <img src="/assets/placeholders/finance.jpg" alt="Tableau de bord PolyScan avec indicateurs financiers" loading="lazy" />
                </div>
              </div>
            </div>
          </article>
      ...
      <footer className="site-footer">
        <div className="container">
          <span>© 2025 PolyScan</span>
          <span>Plateforme premium de renseignement financier automatisé.</span>
        </div>
      </footer>

      <button className="chat-button" aria-label="Ouvrir le chatbot PolyScan">
